/* Builds a frequency counter object from an array
 ...
 */
function convertAndValidateNumsArr(numsAsStrings){
    let result = [];
    ...
    for (let i = 0; i < numsAsStrings.length; i++){
        ...
        if (Number.isNaN(valToNumber)){
            return new Error(`The Value '${numsAsStrings[i]} at index ${i} is not a valid number. Please enter a valid number.`);
        }
